...
export const FORMAT_INFO: Record<FileFormat, FormatInfo> = {
  ...
  // ===== DOCUMENTS =====
  pdf: { format: 'pdf', label: 'PDF', mimeTypes: ['application/pdf'], category: 'document', maxSize: 50 * 1024 * 1024 },
  docx: { format: 'docx', label: 'DOCX', mimeTypes: ['application/vnd.openxmlformats-officedocument.wordprocessingml.document'], category: 'document', maxSize: 50 * 1024 * 1024 },
  txt: { format: 'txt', label: 'TXT', mimeTypes: ['text/plain'], category: 'document', maxSize: 20 * 1024 * 1024 },
  odt: { format: 'odt', label: 'ODT', mimeTypes: ['application/vnd.oasis.opendocument.text'], category: 'document', maxSize: 50 * 1024 * 1024 },
  rtf: { format: 'rtf', label: 'RTF', mimeTypes: ['application/rtf', 'text/rtf'], category: 'document', maxSize: 30 * 1024 * 1024 },
  epub: { format: 'epub', label: 'EPUB', mimeTypes: ['application/epub+zip'], category: 'document', maxSize: 50 * 1024 * 1024 },
  ...
  doc: { format: 'doc', label: 'DOC', mimeTypes: ['application/msword'], category: 'document', maxSize: 50 * 1024 * 1024 },
...
export const CONVERSION_CONFIG: ConversionConfig = {
  ...
  document: {
    formats: ['pdf', 'docx', 'txt', 'odt', 'rtf', 'epub', 'html', 'xml', 'json', 'yaml', 'csv', 'doc'],
    conversions: {
      pdf: ['txt', 'html', 'docx', 'odt', 'rtf'],
      docx: ['pdf', 'txt', 'html', 'odt', 'rtf', 'doc'],
      txt: ['pdf', 'html', 'docx', 'odt', 'rtf'],
      odt: ['pdf', 'docx', 'txt', 'html', 'rtf'],
      rtf: ['pdf', 'docx', 'txt', 'html', 'odt'],
      epub: ['pdf', 'txt', 'html'],
      html: ['pdf', 'txt', 'docx', 'odt'],
      xml: ['json', 'yaml', 'txt', 'html'],
